...
class VProveedoresTable extends SupabaseTable<VProveedoresRow> {
  @override
  String get tableName => 'v_proveedores';

  @override
  VProveedoresRow createRow(Map<String, dynamic> data) => VProveedoresRow(data);
}

class VProveedoresRow extends SupabaseDataRow {
  VProveedoresRow(super.data);

  @override
  SupabaseTable get table => VProveedoresTable();
