...
class VTerOseantTable extends SupabaseTable<VTerOseantRow> {
  @override
  String get tableName => 'v_ter_oseant';

  @override
  VTerOseantRow createRow(Map<String, dynamic> data) => VTerOseantRow(data);
}

class VTerOseantRow extends SupabaseDataRow {
  VTerOseantRow(super.data);

  @override
  SupabaseTable get table => VTerOseantTable();
