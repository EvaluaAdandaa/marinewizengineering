...
class VRpCotizacionesTable extends SupabaseTable<VRpCotizacionesRow> {
  @override
  String get tableName => 'v_rp_cotizaciones';

  @override
  VRpCotizacionesRow createRow(Map<String, dynamic> data) =>
      VRpCotizacionesRow(data);
}

class VRpCotizacionesRow extends SupabaseDataRow {
  VRpCotizacionesRow(super.data);

  @override
  SupabaseTable get table => VRpCotizacionesTable();
