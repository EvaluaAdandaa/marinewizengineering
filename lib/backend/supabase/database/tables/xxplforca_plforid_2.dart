...
class XxplforcaPlforid2Table extends SupabaseTable<XxplforcaPlforid2Row> {
  @override
  String get tableName => 'xxplforca_plforid_2';

  @override
  XxplforcaPlforid2Row createRow(Map<String, dynamic> data) =>
      XxplforcaPlforid2Row(data);
}

class XxplforcaPlforid2Row extends SupabaseDataRow {
  XxplforcaPlforid2Row(super.data);

  @override
  SupabaseTable get table => XxplforcaPlforid2Table();
